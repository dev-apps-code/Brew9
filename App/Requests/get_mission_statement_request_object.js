...
class GetMissionStatementRequestObject extends BaseRequestObject{

   getUrlString() {
       return `members/${this.url_id}/mission_statements`
   }
}
export default GetMissionStatementRequestObject
...
loadMore(){
    ...
    if (!loading_list){
        if (orders_total > orders_data.length) {
            this.loadMissionStatements(orders_page)
        }
    }
}
