...
class GetPointProductRedemptionRequestObject extends BaseRequestObject{
   ...
   getUrlString() {
       return `members/${this.url_id}/point_product_redemption`
   }
}
export default GetPointProductRedemptionRequestObject
...
loadMore(){
    ...
    if (!loading_list){
        if (orders_total > orders_data.length) {
            this.loadPointProductRedemption(orders_page)
        }
    }
}
