          ...
          >
            <View style={styles.productDetailView}>
              ...
              {item.variations != null && item.variations != '' ? (
                <Text style={styles.productVariantText}>{item.variations}</Text>
              ) : (
    ...
    const voucher_items = vouchers.map((item, key) => {
      ...
      if (item.voucher.discount_type == 'fixed') {
        ...
        voucher_discount = `-$${parseFloat(
          cart_total * (item.voucher.discount_price / 100)
        ).toFixed(2)}`;
      }

      return (
        <View style={styles.voucherView} key={key}>
          <Text style={styles.voucherNameText}>{item.voucher.name}</Text>
          <View
            style={{
              flex: 1
            }}
          />
          <Text style={styles.voucherDescriptionText}>{voucher_discount}</Text>
        </View>
      );
    });
          ...
          <View style={styles.orderCartView}>
            ...
            >
              <View style={styles.completeOrderView}>
                ...
                />
                <Text style={styles.completedOrderText}>Completed Order</Text>
                <View
                  style={{
                    flex: 1
                  }}
                />
                <Text style={styles.thankMessageText}>
                  Thank you, let's brew again.
                </Text>
              </View>
              ...
              <View style={styles.locationWrapperView}>
                <View style={styles.locationView}>
                  <View style={styles.branchView}>
                    <Text style={styles.shopBranchText}>{order.shop.name}</Text>
                    <Text
                      numberOfLines={3}
                      style={styles.shopBranchAddressText}
                    >
                      {order.shop.short_address}
                    </Text>
                  </View>
                  <View
                    style={{
