...
export default class Profile extends React.Component {
  ...
  onFeedbackPressed = () => {
    ...
    Linking.openURL(
      'mailto:feedback@brew9.co?subject=Brew9 app feedback' +
        ' (' +
        os_string +
        '-' +
        getAppVersion() +
  ...
  render() {
    ...
    if (currentMember != null) {
      ...
      level_name = currentMember.premium_membership
        ...
        : currentMember.free_membership.membership_level.name;
      display_name = currentMember.name
        ? currentMember.name
        : currentMember.phone_no;
      membership_name = currentMember.premium_membership
        ? currentMember.premium_membership.membership_plan.name
        : currentMember.free_membership.membership_plan.name;
      ...
      member_exp = currentMember.premium_membership
        ? currentMember.premium_membership.experience_points
        : currentMember.free_membership.experience_points;
      exp_needed = currentMember.premium_membership
        ? currentMember.premium_membership.membership_level.maximum_experience
        : currentMember.free_membership.membership_level.maximum_experience;
      membership_progress = currentMember.premium_membership
        ? currentMember.premium_membership.experience_points /
          currentMember.premium_membership.membership_level.maximum_experience
        : currentMember.free_membership.experience_points /
          currentMember.free_membership.membership_level.maximum_experience;
      next_level_name = currentMember.premium_membership
        ...
        <ScrollView>
          ...
          >
                  ...
                  >
                    ...
                    >
                      <View style={styles.membershipinfoView}>
                        ...
                        >
                          ...
                          {membership_name != '' && (
                            <View style={styles.membershiplevelButton}>
                              <Text style={styles.membershiplevelText}>
                                {level_name}
                              </Text>
                            </View>
                          )}
                    ...
                    >
                      <ProfileRowMenu
                        ...
                        iconStyle={styles.pointiconImage}
                        value={points}
                        title={'Point'}
                      />
                      <ProfileRowMenu
                        onPress={this.onRewardButtonPressed}
                        icon={require('./../../assets/images/voucher_center.png')}
                        iconStyle={styles.rewardiconImage}
                        value={vouchers_count}
                        title={'Voucher'}
                      />
                      <ProfileRowMenu
                        onPress={this.onWalletButtonPressed}
                        icon={require('./../../assets/images/wallet_center.png')}
                        iconStyle={styles.walletIconImage}
            ...
            >
              ...
              <Text style={styles.companySloganText}>
                {this.state.appSlogan}
              </Text>
            </View>
          </View>
          {/* <TouchableOpacity
          ...
          <View style={styles.menuView}>
            <ProfileMenu
              ...
              text={'Order History'}
              icon={require('./../../assets/images/Icon_Profile-OrderHistory.png')}
            />
            <ProfileMenu
