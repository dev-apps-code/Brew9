...
export default class CheckoutVoucher extends React.Component {
  ...
  onHowToUsePressed = async () => {
    ...
    analytics.event(
      new Event('Voucher', getMemberIdForApi(currentMember), 'How to use')
    );
    ...
    if (this.state.valid_selected) {
      return (
        <ValidVoucher
          ...
          addVoucherAction={this.props.navigation.getParam(
            'addVoucherAction',
            null
          )}
      ...
      <View style={styles.rewardView}>
        ...
        >
          <View style={styles.voucherviewView}>
            ...
            <View style={styles.voucherlistviewFlatListViewWrapper}>
              <FlatList
