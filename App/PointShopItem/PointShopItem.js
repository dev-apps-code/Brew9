...
export default class PointShopItem extends React.Component {
  ...
  render() {
    ...
    return (
      <View style={styles.pointItemView}>
        <Image
        ...
        <View
          ...
          <View style={styles.viewThreeView}>
            <Text style={styles.titleTwoText}>Product Type</Text>
            <Text style={styles.pointsText}>
              {' '}
              - {toTitleCase(`${data.product_type}`)}
            </Text>
          </View>
          <View style={styles.viewFourView}>
            <Text style={styles.titleThreeText}>Valid Date</Text>
            <Text style={styles.pointsText}>
              {' '}
              - {data.expired_in} {data.expired_in_type} from date of purchase
            </Text>
          </View>
          <View style={styles.viewFiveView}>
            <Text style={styles.titleFourText}>Time of use</Text>
            <Text style={styles.pointsText}>
              {' '}
              - {toTitleCase(`${data.can_use_time}`)}
            </Text>
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          style={
            data.can_purchase
              ? [styles.purchaseButton, commonStyles.normal]
              : [styles.purchaseButton, commonStyles.disabled]
          }>
